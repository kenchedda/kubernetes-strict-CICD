        ...
        stage ('Helm Chart') {
          steps {
            ...
            dir('charts') {
              ...
              curl -ujnrcheddabob@gmail.com:Widaad@77 -T /home/ec2-user/workspace/job/charts/webapp-1.0.tgz "https://kenappiah.jfrog.io/artifactory/default-helm/webapp-1.0.tgz"
