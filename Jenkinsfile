        ...
        stage ('Helm Chart') {
          steps {
            ...
            dir('charts') {
              ...
              sh '/usr/local/bin/helm-push /home/ec2-user/workspace/job/charts/webapp-1.0.tgz  https://kenappiah.jfrog.io/artifactory/default-helm/ --username $username --password $password'
              }
            }
          }
        }
