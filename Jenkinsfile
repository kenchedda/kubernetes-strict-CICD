        ...
        stage ('Helm Chart') {
          steps {
            ...
            dir('charts') {
              ...
              sh '/usr/local/bin/helm repo add default-helm-local  https://kenappiah.jfrog.io/artifactory/default-helm-local/ --username jnrcheddabob@gmail.com --password Widaad@77'
